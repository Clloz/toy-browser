 ...
 * @LastEditTime: 2020-08-01 15:05:41
 * @LastEditors: Clloz
 * @Description:css layout compute
 * @FilePath: /toy-browser/layout.js
...
function layout(element) {
    ...
    if (mainSpace < 0) {
        //overflow (only happens in one single line, scale every item)
    ...
    flexLines.forEach(function (items) {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            if (align === 'stretch') {
                itemStyle[crossStart] = crossBase;
                itemStyle[crossEnd] = crossBase + crossSign * lineCrossSize;
                console.log(itemStyle[crossSize]);
                itemStyle[crossSize] = itemStyle.flex
